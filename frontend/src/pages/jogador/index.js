...
import JogadorIndexStore from '../../stores/jogador/indexStore';
...
@observer
class JogadorIndexPage extends GenericIndexPage {
  constructor(props) {
    super(props);
    this.store = new JogadorIndexStore();
  }
  ...
  render() {
        ...
        body: (rowData) => {
          return (
            <div className="actions">
              <Link to={UrlRouter.jogador.editar.replace(':id', rowData.id)}>
    ...
    const header = (
      <div className="table-header">
        <Link to={UrlRouter.jogador.novo}>
    ...
    const breacrumbItems = [{ label: 'Jogador' }];
...
export default JogadorIndexPage;
