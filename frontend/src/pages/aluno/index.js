...
import AlunoIndexStore from '../../stores/aluno/indexStore';
...
@observer
class AlunoIndexPage extends GenericIndexPage {
  constructor(props) {
    super(props);
    this.store = new AlunoIndexStore();
  }
  ...
  render() {
        ...
        body: (rowData) => {
          return (
            <div className="actions">
              <Link to={UrlRouter.aluno.editar.replace(':id', rowData.id)}>
    ...
    const breacrumbItems = [{ label: 'Aluno' }];
